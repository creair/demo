			...
			createDateTimePicker = function( input ) {
					...
					if( options.validateOnBlur ) {
						input
							...
							.on('blur.xdsoft', function() {
								...
								_xdsoft_datetime.currentTime.setHours(timebox.find(".xdsoft_current").data('hour'));
								_xdsoft_datetime.currentTime.setMinutes(timebox.find(".xdsoft_current").data('minute'));

								if( options.allowBlank && !$.trim($(this).val()).length ) {
									$(this).val(null);
									datetimepicker.data('xdsoft_datetime').empty();
								}else if( !Date.parseDate( $(this).val(), options.format ) ) {
									$(this).val((_xdsoft_datetime.getCurrentTime()).dateFormat( options.format ));
				...
				calendar
					.on('click.xdsoft','td',function() {
						...
						currentTime.setHours(timebox.find(".xdsoft_current").data('hour'));
						currentTime.setMinutes(timebox.find(".xdsoft_current").data('minute'));
